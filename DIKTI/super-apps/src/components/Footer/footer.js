function Footer() {
  return (
    <footer class="body-font bg-blue-500 h-22">
      <div className="container flex flex-wrap flex-col md:flex-row items-center">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p class="text-white text-sm text-center sm:text-left">Direktorat Jendral Pendidikan Tinggi @2021 All Right Reserved
          </p>
