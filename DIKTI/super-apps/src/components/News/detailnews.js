    ...
    <section className="body-font items-center mx-16 my-auto">
      <div className="container mx-auto my-10">
        <div className="flex items-center mb-14">
          <h1 className="text-4xl font-medium title-font text-black">Berita</h1>
          {/* SEARCH BAR */}
            ...
            <div className="flex ml-16">
              <div className="mx-auto w-72 text-gray-500 mr-2">
                ...
                <h2 className="text-gray-900 title-font text-lg font-medium">
                  Berikut adalah judul berita yang cukup panjang hingga
                  mengambil 3 baris dan...
                </h2>
              </div>
        ...
        <div className="grid grid-cols-3 grid-flow-row">
          <div className="mx-auto max-w-2xl w-80">
            ...
            <h2 className="text-gray-900 title-font text-md font-medium mt-4">
              Judul berita yang panjang banget judul berita yang panjang banget
              Judul berita yang panjang banget
            </h2>
            <p className="mt-2 mx-auto text-gray-500">
